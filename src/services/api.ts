/* This TypeScript code snippet is a module that fetches news articles from different sources (NewsAPI,
The Guardian, and The New York Times) based on specified filters. Here's a breakdown of what the
code does: */
    ...
    const response = await axios.get('https://api.nytimes.com/svc/search/v2/articlesearch.json', {
      params: {
        ...
        fq: filters.category !== 'All'
          ? `section_name:"${categoryMappings.nytimes[filters.category as keyof typeof categoryMappings.nytimes]}"`
          : ''
      },
    });
